...
export function StatusBanner() {
  return (
    <div className="relative flex flex-col items-center gap-3 overflow-hidden rounded-[12px] border-[0.5px] border-border/70 bg-[var(--surface-card)] p-5 text-center shadow-[var(--shadow-card)] dark:border-white/10 dark:bg-[linear-gradient(180deg,#292925_0%,#22221f_100%)] sm:p-6">
